...
/**
 * {@link Semaphore} implementation provides {@link Semaphore#down()} and {@link Semaphore#up()} methods.
 * 
 * 
...
public interface Semaphore {
     ...
     * <ul>
     * <li>Some other thread invokes the release() method for this semaphore and the current thread 
     * is next to be assigned a permit; or
